...
// Reemplazos ULTRA seguros (SOLO botón y URL)
...
console.log('Aplicando SOLO cambios ultra seguros (botón y URL)...\n');
console.log('NOTA: NO se tocarán títulos ni nada relacionado con enrutamiento\n');

let totalModified = 0;

ultraSafeReplacements.forEach(replacement => {

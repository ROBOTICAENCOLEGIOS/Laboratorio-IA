...
console.log('Aplicando SOLO cambio de botón principal (sin tocar títulos ni enrutamiento)...\n');
console.log('NOTA: NO se modificarán títulos ni nada relacionado con enrutamiento\n');

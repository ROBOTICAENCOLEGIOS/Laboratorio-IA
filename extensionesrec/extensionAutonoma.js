...
(function (Scratch) {
  ...
  const I18N_BLOCKS = {
    ...
    "pl": {
      "ext_title": "ROBOT 1 Arduino AUTONOMOUS",
      "arduino_autonomo_loaded_msg": "ROBOT 1 Arduino AUTONOMOUS załadowany! Szukaj bloków na dole lewej palety 👇",
      "hat_inicio": "START 🚀",
      "block_move_motor": "Porusz silnikiem [MOTOR] [DIRECCION] [VELOCIDAD]%",
      "motor_a": "Silnik A",
      "motor_b": "Silnik B",
      "motor_both": "OBA / WSZYSTKIE",
      "dir_forward": "DO PRZODU",
      "dir_backward": "DO TYŁU",
      "block_stop_motor": "Zatrzymaj silnik [WHICH]",
      "block_light_on": "Światło [LED] → kolor [COLOR]",
      "block_light_off": "Zgaś światło [LED]",
      "block_play_note": "Zagraj nutę [NOTE] przez [MS] ms",
      "block_distance_cm": "odległość (cm)",
      "block_line_detected": "wykryto linię?",
      "block_get_dht": "odczytaj [TIPO]",
      "block_compile": "⚙️ Skompiluj program C++",
      "block_upload": "⬆️ Wgraj na Robota 🚀",
      "block_download_agent": "⬇️ Pobierz kompilator (Windows)",
      "block_upload_status": "📡 status wgrywania",
      "block_log": "🪲 dziennik błędów",
      "led_all": "WSZYSTKIE",
      "dht_temp": "Temperatura (°C)",
      "dht_hum": "Wilgotność (%)",
      "note_do": "DO (C4)",
    ...
    "nl": {
      "ext_title": "ROBOT 1 Arduino AUTONOMOUS",
      "arduino_autonomo_loaded_msg": "ROBOT 1 Arduino AUTONOMOUS geladen! Zoek de blokken onderaan het linkerpalet 👇",
      "hat_inicio": "START 🚀",
      "block_move_motor": "Beweeg motor [MOTOR] [DIRECCION] [VELOCIDAD]%",
      "motor_a": "Motor A",
      "motor_b": "Motor B",
      "motor_both": "BEIDE / ALLE",
      "dir_forward": "VOORUIT",
      "dir_backward": "ACHTERUIT",
      "block_stop_motor": "Stop motor [WHICH]",
      "block_light_on": "Licht [LED] → kleur [COLOR]",
      "block_light_off": "Licht [LED] uit",
      "block_play_note": "Speel noot [NOTE] gedurende [MS] ms",
      "block_distance_cm": "afstand (cm)",
      "block_line_detected": "lijn gedetecteerd?",
      "block_get_dht": "lees [TIPO]",
      "block_compile": "⚙️ Compileer C++ programma",
      "block_upload": "⬆️ Upload naar Robot 🚀",
      "block_download_agent": "⬇️ Download Compiler (Windows)",
      "block_upload_status": "📡 upload status",
      "block_log": "🪲 foutenlogboek",
      "led_all": "ALLE",
      "dht_temp": "Temperatuur (°C)",
      "dht_hum": "Vochtigheid (%)",
      "note_do": "DO (C4)",
      "note_re": "RE (D4)",
      "note_mi": "MI (E4)",

...
(function (Scratch) {
  ...
  const I18N_BLOCKS = {
    es: {
      ...
      block_cam_x: '📷 coordenada X de la cámara',
      block_cam_y: '📷 coordenada Y de la cámara',
    ...
    en: {
      ...
      block_cam_x: '📷 camera X coordinate',
      block_cam_y: '📷 camera Y coordinate',
    ...
    pt: {
      ...
      block_cam_x: '📷 coordenada X da câmera',
      block_cam_y: '📷 coordenada Y da câmera',
      block_object: 'objeto detectado',
    ...
    fr: {
      ...
      block_cam_x: '📷 coordonnée X de la caméra',
      block_cam_y: '📷 coordonnée Y de la caméra',
    ...
    de: {
      ...
      block_cam_x: '📷 Kamera X-Koordinate',
      block_cam_y: '📷 Kamera Y-Koordinate',
    ...
    it: {
      ...
      block_cam_x: '📷 coordinata X fotocamera',
      block_cam_y: '📷 coordinata Y fotocamera',
    ...
    zh: {
      ...
      block_cam_off: '❌ 关闭摄像头',
      block_cam_x: '📷 摄像头 X 坐标',
      block_cam_y: '📷 摄像头 Y 坐标',
      block_object: '检测到的物体',
    ...
    ja: {
      ...
      block_cam_x: '📷 カメラ X 座標',
      block_cam_y: '📷 カメラ Y 座標',
      block_object: '検出された物体',
      block_confidence: '精度 %',
      block_category: 'カテゴリ [CATEGORIA] を見ている?',
      block_pos_x: '物体 X 位置',
      block_pos_y: '物体 Y 位置',
      mode_fixed: '固定フローティング',
    ...
    ko: {
      ...
      block_cam_x: '📷 카메라 X 좌표',
      block_cam_y: '📷 카메라 Y 좌표',
      block_object: '감지된 물체',
    ...
    ru: {
      ...
      block_cam_x: '📷 координата X камеры',
      block_cam_y: '📷 координата Y камеры',
      ...
      mode_fixed: 'ФИКСИРОВАННОЕ ПЛАВАЮЩЕЕ',
    ...
    ar: {
      ...
      block_cam_x: '📷 إحداثي X للكاميرا',
      block_cam_y: '📷 إحداثي Y للكاميرا',
    ...
    hi: {
      ...
      block_cam_x: '📷 कैमरा X निर्देशांक',
      block_cam_y: '📷 कैमरा Y निर्देशांक',
    ...
    tr: {
      ...
      block_cam_x: '📷 kamera X koordinatı',
      block_cam_y: '📷 kamera Y koordinatı',
    ...
    pl: {
      ...
      block_cam_x: '📷 współrzędna X kamery',
      block_cam_y: '📷 współrzędna Y kamery',
    ...
    nl: {
      ...
      block_cam_x: '📷 camera X-coördinaat',
      block_cam_y: '📷 camera Y-coördinaat',
    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          "---",
          { opcode: 'getCamaraX', blockType: Scratch.BlockType.REPORTER, text: t('block_cam_x') },
          { opcode: 'getCamaraY', blockType: Scratch.BlockType.REPORTER, text: t('block_cam_y') },
          "---",
        ...
        menus: {
          MODO_CAMARA: {
            items: [
              { text: t('mode_fixed'), value: 'FLOTANTE FIJA' },
